...
export default function Settings({ triggerToast }: SettingsProps) {
  ...
  const [vtKey, setVtKey] = useState('vt_private_recon_key_2026_xyz');
          ...
          <div className="bg-white p-5 rounded-xl border border-[#E2E8F0] shadow-sm space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label className="block text-xs font-bold uppercase tracking-wider text-slate-600">Gemini-3.5 API Key</label>
                <input 
                  type="password"
                  value={apiKey}
