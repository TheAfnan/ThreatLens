            ...
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              <div className="flex items-center space-x-3 border-l border-white/30 pl-4 md:pl-8">
                ...
                <div className="shadow-glass transition-transform hover:scale-105 ml-2">
                  <UserButton afterSignOutUrl="/" appearance={{ elements: { avatarBox: "h-9 w-9 md:h-10 md:w-10 border border-white/50" } }} />
                </div>
              </div>
            </div>
          </header>
        ...
        <main className={`${isSignedIn && !isPublicRoute ? 'p-4 md:p-6 flex-grow max-w-7xl w-full mx-auto pb-12' : 'w-full'}`}>
          <AnimatePresence mode="wait">
            <Routes location={location} key={location.pathname}>
              ...
              <Route path="/legal/:type" element={<Suspense fallback={<PageLoader />}><PageTransition><Legal type="privacy" onBack={() => navigate('/')} /></PageTransition></Suspense>} />
